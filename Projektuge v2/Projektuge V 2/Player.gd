...
func _physics_process(_delta):
	...
	if GlobalScript.player_Health == 6:
		respawn()
	if GlobalScript.player_Health == 5:
		respawn_2()
...
func respawn():
	position.x = 24
	position.y = 672
	GlobalScript.player_Health += 4
	
func respawn_2():
	position.x = 24
	position.y = 672
	GlobalScript.player_Health += 5
	
func get_knowledge():
	pass

func _on_SU1_entered_body(body):
	SU += 1
	print(SU)

func _on_SU2_entered_body(body):
	SU += 1
	print(SU)

func _on_SU3_entered_body(body):
	SU += 1
	print(SU)

func _on_SU4_entered_body(body):
	SU += 1
	print(SU)
